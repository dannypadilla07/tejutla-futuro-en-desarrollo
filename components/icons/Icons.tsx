...
export const LogoIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
    <path d="M12 2L1 9l4 2.18v6.32L12 22l7-4.5v-6.32L23 9l-5-2.5V9l-3 1.5-4-2.5-4 2.5-3-1.5V6.5L12 4l5 2.5V9l-3 1.5-4-2.5-4 2.5-3-1.5V6.5L12 4l5 2.5V9l-3 1.5-4-2.5-4 2.5-3-1.5V6.5L12 4l7 3.5-7 3.5-7-3.5L12 2zm0 2.5l-4 2 4 2 4-2-4-2z"/>
  </svg>
);
